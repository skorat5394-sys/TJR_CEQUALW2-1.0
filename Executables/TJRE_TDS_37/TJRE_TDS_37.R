save_file_path <-  "C:/W2/post_usage_analysis/CAL_runs/TJRE_TDS_37"
setwd(save_file_path)
getwd()

seg2 <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/tsr_1_seg2.csv")
seg214 <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/tsr_2_seg214.csv")
seg252 <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/tsr_3_seg252.csv")
seg325 <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/tsr_4_seg325.csv")
seg377 <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/tsr_5_seg377.csv")
...
EDH <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/EDH_cal.csv", skip = 2)
QIN <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/QIN_cal.csv", skip = 2)

CDH <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/cdh_br1.csv", skip = 2)
CIN <- read.csv("C:/W2/Usage/TJRE_cal_runs/TJRE_TDS_cal/TJRE_TDS_37/CIN_15.csv", skip = 2)
